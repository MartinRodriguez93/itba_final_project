...
# Common variables
RUN_DS = '{{ ds }}'
TEMPLATE_SEARCHPATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../bigquery_etl/sql")
RAW_DB = "RAW"
# SF_STAGING_DB = "STAGING"
# SF_SCHEMA = "ORDERS"
BIGQUERY_SCHEMA = "ORDERS"
...
with DAG('bigquery_dag', default_args=DEFAULT_ARGS, template_searchpath=[TEMPLATE_SEARCHPATH]) as dag:
    ...
    for dataset, params in DAG_DICT.items():
        ...
        append_rows_task = GoogleCloudStorageToBigQueryOperator(
            ...
            destination_project_dataset_table=f"{RAW_DB}.{TABLE_NAME}",
        ...
        download_task >> transform_source_system_task >> local_to_gcs_task >> append_rows_task
        # download_task >> delete_query_task >> transform_source_system_task >> local_to_gcs_task >> append_rows_task
